...
# Return the boxes around the detected object
...
# Crate the a method for drawing on the images
...
# Draw the boxs around the image with information
# about prediction score
